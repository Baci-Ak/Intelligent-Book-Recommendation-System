        ...
        if choice == '1':
            ...
            if matrix_choice == '1':
                try:
                    ...
                    similarity_score = s.minkowski_distance_similarity(user_preference, user1_id, user2_id, p_value)
            ...
            if matrix_choice == '1':
                try:
                    similarity_score = s.cosine_similarity(user_preference, book1_isbn, book2_isbn)
                ...
                try:
                    similarity_score = s.hamming_distance_similarity(user_preference, book1_isbn, book2_isbn)
            ...
            justification = s.evaluate_similarity_matrices(user_preference, test_data)
            print(justification)
        elif choice == '4':
